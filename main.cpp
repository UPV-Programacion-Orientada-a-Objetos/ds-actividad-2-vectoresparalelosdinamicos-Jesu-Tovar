...
void inspeccionarFrente() {
    ...
    std::cout << "  ID: " << ids[frente]
              << " | Peso: " << pesos[frente] << " kg"
              << " | Destino: " << destinos[frente]
              << " | Prioridad: ";
    if (prioridades[frente] == 1) std::cout << "Alta";
    else if (prioridades[frente] == 2) std::cout << "Media";
    else std::cout << "Baja";
    std::cout << "\n";
}
...
int main() {
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 3: inspeccionarFrente(); break;
            case 4: reporteDestino(); break;
